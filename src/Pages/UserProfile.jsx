    ...
    <div className="us-root">
      <header className="user-header">
        ...
        <div className="user-header__right">
          ...
          <Link to="/settings" className="us-navlink">Settings</Link>
        </div>
      </header>
      ...
      <main className="us-main">
        <section className="us-panel">
          ...
          <h1>My Profile</h1>
          <p className="us-copy">Basic account details currently stored in your session.</p>
          ...
          <div className="us-actions">
            ...
            <Link to="/settings" className="us-btn us-btn--primary">Open Settings</Link>
          </div>
        </section>
      </main>
