    ...
    <div className="us-root">
      <header className="user-header">
        ...
        <div className="user-header__right">
          ...
          <Link to="/profile" className="us-navlink">Profile</Link>
        </div>
      </header>
      ...
      <main className="us-main">
        <section className="us-panel">
          ...
          <p className="us-copy">Manage your account actions and access to the booking platform.</p>

          <div className="us-section">
            <h2>Quick Actions</h2>
            <div className="us-actions">
              <Link to="/home" className="us-btn us-btn--ghost">Back to Resources</Link>
              <button type="button" className="us-btn us-btn--primary" onClick={() => setLogoutOpen(true)}>
                Log Out
              </button>
            </div>
          </div>
          ...
          <div className="us-section us-section--danger">
            <div>
              ...
              <p className="us-copy">
                This will permanently remove your user account access and sign you out immediately.
              </p>
            </div>
            <button type="button" className="us-btn us-btn--danger" onClick={() => setDeleteOpen(true)}>
              Delete My Account
            </button>
          </div>
        </section>
